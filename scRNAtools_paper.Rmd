...
output:
    bookdown::word_document2:
        ...
        pandoc_args: [ "--csl", "style/vancouver.csl" ]
...
2016. In the year since then over 130 new tools have been added (Fig
...
bioRxiv preprint server (Fig \@ref(fig:overview-panel)B). Tools can be split
...
preprints (Fig \@ref(fig:overview-panel)C). This is a good demonstration of
...
repositories (Fig \@ref(fig:overview-panel)D). Python is the second most
