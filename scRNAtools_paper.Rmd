...
used for the analysis presented in this paper. Data was manipulated in R using
the dplyr package (v`r packageVersion("dplyr")`) [@Wickham2017-ip] and plots
produced using the ggplot2 (v`r packageVersion("ggplot2")`) and cowplot
