...
save_plot("figures/overview_panel.png", panel, nrow = 3, ncol = 2,
          base_height = 8)
save_plot("figures/overview_panel.pdf", panel, nrow = 3, ncol = 2,
          base_height = 8)
```
...
include_graphics("figures/overview_panel.png")
```
...
of several tasks which can be completed using various tools [@Bacher2016-
en, @Wagner2016-zm, @Miragaia2017-tq, @Poirion2016-da, @Rostom2017-dc]. In
...
save_plot("figures/categories_panel.png", panel, nrow = 3, ncol = 2,
          base_height = 8)
save_plot("figures/categories_panel.pdf", panel, nrow = 3, ncol = 2,
          base_height = 8)
```
...
include_graphics("figures/categories_panel.png")
```
